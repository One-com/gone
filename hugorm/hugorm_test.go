...
func initJSON() {
	initConfig("json", string(jsonExample))
}
...
func TestDefault(t *testing.T) {
	...
	err := AddConfigFrom("yaml", bytes.NewBuffer(yamlExample))
...
func TestOverrides(t *testing.T) {
	SetDefault("name", "snog")
	Set("name", "hugorm")
	SetDefault("name", "slange")
	assert.Equal(t, "hugorm", Get("name"))
}
